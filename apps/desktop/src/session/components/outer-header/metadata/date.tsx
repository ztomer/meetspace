    ...
    return (
      <div className="flex h-9 items-center justify-between gap-3">
        <div className="min-w-0 flex-1">
          <div className="text-foreground text-sm">{noteDate}</div>
        </div>
        <Button
          type="button"
          variant="ghost"
          ...
          <div className="flex h-9 items-center gap-0">
            ...
            {onCancel && (
              <Button
                ...
                variant="ghost"
                size="icon"
                className="text-muted-foreground hover:bg-destructive-bg hover:text-destructive size-7 shrink-0 rounded-md"
                onClick={onCancel}
            ...
            <form.Subscribe selector={(state) => [state.canSubmit]}>
              {([canSubmit]) => (
                <Button
                  ...
                  variant="ghost"
                  size="icon"
                  className="text-muted-foreground hover:bg-success-bg hover:text-success-fg size-7 shrink-0 rounded-md"
