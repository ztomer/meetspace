  ...
  return (
    ...
    >
      ...
      <div className={cn(["min-w-0 flex-1"])}>
        <div
          className={cn([
            "[&_mark]:text-foreground truncate text-sm font-normal [&_mark]:bg-yellow-200 [&_mark]:font-semibold",
          ])}
...
function SessionSearchResultItem({
  ...
  return (
    ...
    >
      <div
        className={cn([
          "text-foreground truncate text-sm font-medium [&_mark]:bg-yellow-200 [&_mark]:font-semibold",
          "w-full",
        ])}
      ...
      {snippet && (
        <div
          className={cn([
            "text-muted-foreground [&_mark]:text-foreground line-clamp-2 text-xs [&_mark]:bg-yellow-200 [&_mark]:font-semibold",
          ])}
