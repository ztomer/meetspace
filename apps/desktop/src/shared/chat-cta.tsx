    ...
    >
      <span
        ...
        className={cn([
          ...
          "group-hover/meetspace-chat-cta:h-10 group-hover/meetspace-chat-cta:w-[min(640px,calc(100cqw_-_2rem))] group-hover/meetspace-chat-cta:px-4 dark:group-hover/meetspace-chat-cta:h-10",
          "group-focus-visible/meetspace-chat-cta:h-10 group-focus-visible/meetspace-chat-cta:w-[min(640px,calc(100cqw_-_2rem))] group-focus-visible/meetspace-chat-cta:px-4 dark:group-focus-visible/meetspace-chat-cta:h-10",
      ...
      >
        <span
          ...
          className={cn([
            ...
            "group-hover/meetspace-chat-cta:opacity-100",
            "group-focus-within/meetspace-chat-cta:opacity-100",
          ])}
        >
          {resolvedLabel}
        </span>
