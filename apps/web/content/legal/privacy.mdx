...
If you connect Google Calendar or another supported calendar provider, we collect and process the data needed to sync calendars and events into Meetspace. This may include:
