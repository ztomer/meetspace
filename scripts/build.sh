...
#   - pnpm -F @meetspace/desktop build  (Vite production bundle, no Tauri pkg)
#
...
bold "==> pnpm -F @meetspace/ui build (prebuild Tailwind css for desktop)"
...
bold "==> pnpm -F @meetspace/desktop build (Vite bundle)"
pnpm -F @meetspace/desktop build
