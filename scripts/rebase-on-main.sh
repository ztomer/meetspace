...
# `i18n:extract` runs `lingui extract --clean` (REQUIRED: drops obsolete stale
# "Anarlog" msgids that `lingui compile` would otherwise pull in from the .po).
# See scripts/i18n-guard.sh for the shared fork-key check.
