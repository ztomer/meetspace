...
| 6 | **Rebase on upstream stable release v1.0.36** | ✅ Done — branch `MIT_BACK` rebased, compile and typecheck green, rebranding import bugs resolved, tagged `v1.0.36`, and Homebrew Tap cask upgraded. |
